...
export const FUTURE_STATE_SCENARIOS = [
  ...
  },
  {
    ...
    subtitle: 'Strategic agents across PDLC, key human roles in design/dev/test',
    description: 'Deploy AI agents in high-impact phases (testing, CI/CD, monitoring) while retaining core human roles for design, development, and product decisions.',
    humanRoles: ['Product Owner', 'Tech Lead / Architect', 'Developer', 'QA Lead', 'DevOps Engineer'],
    aiAgents: ['FeatureGen Agent', 'CodeGen Agent', 'TestGen Agent', 'AI Test Execution', 'AI Deployment Agent', 'AI APM', 'IncidentAgent'],
    automationLevel: 65,
    color: 'purple',
