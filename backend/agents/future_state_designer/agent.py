...
SCENARIOS = {
    ...
    "option-b": {
        "id":           "option-b",
        "label":        "Option B",
        "title":        "Hybrid — Half-Agent / Half-Human Execution",
        "automation_pct": 50,
        "pt_reduction":   45,
        "wt_reduction":   60,
        "human_roles":  [
            "Product Owner (dedicated per pod)",
            "Developer / Agent Operator ×2 (dedicated per pod)",
            "QA Lead (dedicated per pod)",
            "Tech Lead / Architect (fractional — 0.3–0.5 FTE per pod, shared across 2–3 pods)",
            "Agent Ops / DevOps Engineer (fractional — 0.4 FTE per pod, shared across 2–3 pods)",
        ],
        "agent_count":  11,
        "description":  "~50% of the 21-agent fleet deployed in high-impact PDLC activities. Per pod: 4 dedicated FTE (PO, Dev/Agent-Op ×2, QA Lead) + ~0.7 fractional FTE shared across pods (Tech Lead + Agent Ops). Total effective ~4.7 FTE per pod. The non-agent half of the lifecycle is executed by humans, as in Option A.",
    },
    "option-c": {
        "id":           "option-c",
        "label":        "Option C",
        "title":        "AI-Native — Full 21-Agent Fleet, Humans Review & Approve Only",
        "automation_pct": 90,
        "pt_reduction":   70,
        "wt_reduction":   88,
        "human_roles":  ["Product Definer", "Product Builder", "Engineering Architect (fractional, shared across 3–5 pods)"],
        "agent_count":  21,
        "description":  "All 21 agents execute the full PDLC end-to-end. Humans do not execute work — they only review and approve at gates and policy thresholds. Per pod: Product Definer (1 FTE, sets outcomes) + Product Builder (1 FTE, oversees agent operations and exceptions). Shared across 3–5 pods: Engineering Architect (0.5–1 FTE, sets architecture policy and approves novel patterns).",
    }
}
